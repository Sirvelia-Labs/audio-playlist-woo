    ...
    (function( $ ) {
        ...
        audio.onloadedmetadata = function() {
          ...
          if(play && play == 'true') {
            ...
            if (audioPromise !== undefined) {
                audioPromise.then(_ => {
                    // Autoplay started!
                    $('#sirvelia-player .playPause-btn .apw-play-btn').removeClass("pb-block");
                    $('#sirvelia-player .playPause-btn .apw-play-btn').addClass("pb-hidden");

                    $('#sirvelia-player .playPause-btn .apw-pause-btn').removeClass("pb-hidden");
                    $('#sirvelia-player .playPause-btn .apw-pause-btn').addClass("pb-block");
                }).catch(error => {
      ...
      **********/
      $('#sirvelia-player #player-audio').on('ended', function(e) {
        ...
        if(playlist_ended) { // Posar botó Play/Pause, reiniciar temps i parar
          $('#sirvelia-player .playPause-btn .apw-pause-btn').removeClass("pb-block");
          $('#sirvelia-player .playPause-btn .apw-pause-btn').addClass("pb-hidden");

          $('#sirvelia-player .playPause-btn .apw-play-btn').removeClass("pb-hidden");
          $('#sirvelia-player .playPause-btn .apw-play-btn').addClass("pb-block");
      ...
      **********/
      $('#sirvelia-player .playPause-btn').on('click', function(e) {
        ...
        if( myAudio.attr('src') ) {
          $(this).find('svg').toggleClass("pb-block pb-hidden");
      ...
      $('.add-product-playlist').on('click', function(e) {
        ...
        //if(noSongs) { //Si no hi ha cançons
          ...
          if(viewAlbum.length > 0) {
            ...
            $('#sirvelia-player .player-info .info-data').append('<a href="' + json[0].productUrl + '" class="view-album">' + AudioPlaylistForWoocommerceStrings.view + '</a>');
          }
